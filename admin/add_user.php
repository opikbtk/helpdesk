    ...
    if (empty($username) || empty($password) || empty($nama) || empty($email) || empty($role)) {
        ...
        if ($result->num_rows > 0) {
            ...
            if ($result->num_rows > 0) {
                ...
                // Insert user baru
                $stmt = $conn->prepare("INSERT INTO users (username, password, nama, email, role) VALUES (?, ?, ?, ?, ?)");
...
<h1><i class="fa-solid fa-user-plus"></i> Tambah User</h1>

<div class="card">
    <h2><i class="fa-solid fa-plus"></i> Form Tambah User</h2>
    ...
    <form method="POST" action="" class="form-container">
        ...
        <div class="form-group">
            ...
            <select id="role" name="role" required>
                ...
                <option value="support" <?php echo (isset($_POST['role']) && $_POST['role'] === 'support') ? 'selected' : ''; ?>>Support</option>
